...
% 3: Automate file handling procedure
    ...
    automate_message = questdlg('Automate cropping and file selection?', ...
        'Image processing', ...
        'Yes','No','Cancel');
